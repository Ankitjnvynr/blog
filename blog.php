<?php 
 ...
 if(isset($_POST['Cbtn'])){ 
     ...
     $cmtsql = "INSERT INTO `blog_comments`(`name`, `email`, `comment`, `blog_id`, `status`) VALUES ('$cname','$cemail','$comment','$id','1')"; 
 ...
 <body> 
         ...
         $row2 = mysqli_fetch_assoc($result2); 
                         ...
                         <div class=""> 
                                 ...
                                 <p class="text-body-secondary text-justify"> 
                                         ...
                                         <p class="text-right" > 
                                 <figcaption class="blockquote-footer text-end"><em> 
     Published By: </em>'. $row2['name'] .' <cite title="Source Title"> On '.substr($row['dt'],0,10).'</cite> 
         ...
         <?php 
         $sql3 = "SELECT * FROM `blog_comments` WHERE blog_id = '$id' AND status = '1' "; 
         // echo "$id"; 
         ...
         while ($row3 = mysqli_fetch_assoc($result3)) { 
             ...
             echo ' 
         <div class="card my-3"> 
             <h6 class="card-header d-flex justify-content-between "><em>'.$row3['name'].' (<i>'.$row3['email'].'</i> )</em><em> 
                     '.substr($row3['date'],0,10).'</em></h6> 
             <div class="card-body"> 
  
                 <p class="card-text">'.$row3['comment'].'.</p> 
